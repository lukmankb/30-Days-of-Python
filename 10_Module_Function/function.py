...
if type(add_all_nums(4,3)) == int:
    print(type(add_all_nums()))
else:
    print('The class is not an integer.')
#print(type(add_all_nums(1,2,3)))
#Temperature in °C can be converted to °F using this formula: °F = (°C x 9/5) + 32. Write a function which converts °C to °F, convert_celsius_to-fahrenheit.
def celcius_fahrenheit(celcius):
    fahrenheit = celcius * 9 / 5 + 32
    return fahrenheit
print(celcius_fahrenheit(30), '°F') 
...
def print_list(list = ['apple', 'banana', 'mango']):
    for i in list:
        print(i)
print_list()
...
def capitalize_list_items(list):
    for i in list:
        print(i.capitalize())
capitalize_list_items(['apple', 'banana', 'mango'])
...
print(add_item(list = food_stuff,item = 'Meat'))
numbers = [2, 3, 7, 9]
print(add_item(numbers, item = 5))
...
#Create a function called the most_spoken_languages in the world. It should return 10 or 20 most spoken languages in the world in descending order using countries_data
...
def most_populated_countries(countries_data):
    """Return the top 20 most populated countries."""
